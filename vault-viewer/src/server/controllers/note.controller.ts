...
function mimeFor(ext: string): string {
  switch (ext) {
    case ".png":
      return MIME_BY_EXT[".png"];
    case ".jpg":
      return MIME_BY_EXT[".jpg"];
    case ".jpeg":
      return MIME_BY_EXT[".jpeg"];
    case ".gif":
      return MIME_BY_EXT[".gif"];
    case ".svg":
      return MIME_BY_EXT[".svg"];
    case ".webp":
      return MIME_BY_EXT[".webp"];
    case ".pdf":
      return MIME_BY_EXT[".pdf"];
    default:
