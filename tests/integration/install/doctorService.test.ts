...
} from "../../../src/install/doctor.service.ts";
import {
  defaultManifestPath,
  saveManifest,
} from "../../../src/install/manifest.service.ts";
import { hookCommand } from "../../../src/install/settings.service.ts";
import { defaultSettingsPath } from "../../../src/install/settings.service.ts";
import { RegistryErrorKind } from "../../../src/workspace/registry.service.ts";
