...
import { hookRegistrations } from "../../../src/install/settings.service.ts";
import { dispatchableHookNames } from "../../../src/session/hook.command.ts";
import { HookName } from "../../../src/session/HookName.ts";
