/**
 * Golden-string tests for every `cli.formatter.ts` function — the exact
 * output shapes, character-for-character.
 */
import { describe, expect, test } from "bun:test";

import { NO_HITS_MESSAGE, NO_WORKSPACES_MESSAGE } from "@/cli/cli.constants.ts";
import {
  formatCommitResult,
  formatCommitSkipped,
  formatCwdResolution,
