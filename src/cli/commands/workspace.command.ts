...
import { expandPath, titleize, tildify } from "../../domain/paths.ts";
import type { RawWorkspace, Workspace } from "../../domain/Workspace.ts";
import { buildIndex } from "../../services/index/build.ts";
import { openIndexDb } from "../../services/index/db.ts";
import {
  expandWorkspace,
  saveRegistry,
  validateNew,
} from "../../services/registry.service.ts";
import type { WorkspaceAddArgs, WorkspaceRmArgs } from "../args.ts";
...
import { loadRegistryForCli, noSuchWorkspaceMessage } from "../resolveTarget.ts";
 ...
 * same small utility `services/registry.service.ts`/`services/index/db.ts`
