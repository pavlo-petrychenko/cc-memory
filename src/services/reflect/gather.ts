...
import type { Candidate } from "../../domain/Reflector.ts";
import { dedupeCandidates, extractCandidates } from "../../domain/worklogFormat.ts";
...
function joinUnderDir(dir: AbsPath, name: string): AbsPath {
  ...
  // and normalized — the same reasoning `services/index/build.ts`'s
