...
import { isJsonArray, isJsonObject, type JsonObject } from "./install/json.ts";
import { isLaunchdLoaded } from "./install/launchd.ts";
import { defaultManifestPath, loadManifest } from "./install/manifest.ts";
import { defaultDistPath } from "./install/run.ts";
import {
  commandsInGroup,
  defaultSettingsPath,
  hookCommand,
...
import type { RegistryError } from "./registry.service.ts";
