...
import { defaultRegistryPath } from "../registry.service.ts";
import { type BunPathError, BunPathErrorKind, resolveBunPath } from "./bunPath.ts";
import {
  isJsonArray,
  isJsonObject,
  type JsonFileError,
...
import { seedRegistry } from "./seed.ts";
import {
...
import { defaultShimPath, writeShim } from "./shim.ts";
import { defaultSkillsTargetDir, discoverSkillNames, installSkills } from "./skills.ts";
