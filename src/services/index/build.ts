...
import { parseNote } from "../../domain/note.ts";
import { stripChars } from "../../domain/paths.ts";
import type { Workspace } from "../../domain/Workspace.ts";
import type { Db, DbValue } from "../../ports/db.port.ts";
...
type ExistingWorklogFile = { readonly id: number; readonly mtime: number };
