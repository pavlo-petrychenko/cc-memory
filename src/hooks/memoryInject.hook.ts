...
import type { FusedHit } from "../domain/Hit.ts";
import { HookEvent, HookResultKind } from "../domain/HookResult.ts";
import {
  type InjectedHit,
  renderInjectContext,
} from "../domain/render/inject.renderer.ts";
import { salientTokens } from "../domain/tokenize.ts";
...
type CandidateLogEntry = { readonly p: string; readonly s: number };
