/**
 * One worklog line flagged for KB promotion — a `#promote` line or a long-enough
 * `**Learned:**`/`**Decided:**` line (`bin/reflector.py:71-88`). `src` is the
 * `<slug>/<file>.md` the line came from, used for attribution in the proposals
 * file and the consolidation brief.
 */
